...
public:
  ...
  std::shared_ptr<MemcpyInstruction> MakeMemcpy(const std::string &dst, const std::string &src,
                                                const std::string &size_name, size_t align = 0);
  std::shared_ptr<MemsetInstruction> MakeMemset(const std::string &dst, const std::string &value,
                                                const std::string &size_name, size_t align = 0);
  ...
  std::shared_ptr<InvokeInstruction> MakeInvoke(const std::string &callee,
                                                const std::vector<std::string> &args,
                                                const IRType &ret_type, BasicBlock *normal_dest,
  ...
  std::shared_ptr<CondBranchStatement> MakeCondBranch(const std::string &cond, BasicBlock *true_bb,
                                                      BasicBlock *false_bb);
  ...
  std::shared_ptr<PhiInstruction> MakePhi(
