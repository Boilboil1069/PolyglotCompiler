...
namespace std {
template <> struct hash<polyglot::ir::TemplateInstantiationKey> {
...
public:
  ...
  void RegisterClassTemplate(const std::string &name, const std::vector<TemplateParameter> &params,
                             void *template_ast);

  // Register a function template
  void RegisterFunctionTemplate(const std::string &name,
                                const std::vector<TemplateParameter> &params, void *template_ast,
                                const std::vector<IRType> &param_types = {});

  // Register a template alias (using template)
  void RegisterTemplateAlias(const std::string &name, const std::vector<TemplateParameter> &params,
  ...
  void RegisterSpecialization(const std::string &template_name,
                              ...
                              const std::vector<TemplateParameter> &params, void *specialized_ast,
  ...
  DeductionResult DeduceFromType(const IRType &pattern, const IRType &argument,
...
private:
  ...
  bool TypeMatchesPattern(const IRType &pattern, const IRType &argument,
  ...
  bool IsTemplateParameterType(const IRType &type, const std::set<std::string> &param_names) const;
