...
// 2. Single implementation detection - if a virtual function has only one implementation,
// devirtualize it
...
private:
  ...
  bool TryDevirtualize(ir::CallInstruction *call, ir::BasicBlock *block, ir::Function *func);
