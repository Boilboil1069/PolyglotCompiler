...
public:
  ...
  std::vector<std::string> Extensions() const override { return {".js", ".mjs", ".cjs"}; }

  std::vector<std::string> Aliases() const override { return {"js", "node", "es", "ecmascript"}; }
  ...
  frontends::FrontendResult Lower(const std::string &source, const std::string &filename,
