...
std::string PackageDiscoveryCache::MakeKey(const std::string &language, const std::string &manager,
...
std::unordered_map<std::string, PackageInfo> PackageDiscoveryCache::Retrieve(
...
void PackageDiscoveryCache::Store(const std::string &key,
