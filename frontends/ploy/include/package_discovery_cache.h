...
public:
  ...
  static std::string MakeKey(const std::string &language, const std::string &manager,
  ...
  void Store(const std::string &key, const std::unordered_map<std::string, PackageInfo> &packages);
...
private:
  ...
  std::unordered_map<std::string, std::unordered_map<std::string, PackageInfo>> cache_;
