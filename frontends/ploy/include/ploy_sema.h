...
public:
  ...
  const std::unordered_map<std::string, std::vector<std::pair<std::string, core::Type>>> &
  StructDefs() const {
    return struct_defs_;
  }
...
private:
  ...
  void ReportErrorWithTraceback(const core::SourceLoc &loc, frontends::ErrorCode code,
                                const std::string &message, const core::SourceLoc &related_loc,
  ...
  void RegisterFunctionSignature(const std::string &qualified_name, const FunctionSignature &sig);
  const FunctionSignature *LookupSignature(const std::string &qualified_name) const;
  void ValidateCallArgCount(const core::SourceLoc &call_loc, const std::string &func_name,
                            size_t actual_args, const FunctionSignature *sig);
  void ValidateCallArgTypes(const core::SourceLoc &call_loc, const std::string &func_name,
  ...
  void ValidateReturnType(const core::SourceLoc &call_loc, const std::string &func_name,
  ...
  core::Type ResolveObjectType(const std::string &class_name, const std::string &language,
  ...
  void ValidateObjCallABI(const core::SourceLoc &loc, const std::string &callee_name,
                          const std::string &language, const std::vector<core::Type> &arg_types,
                          const core::Type &return_type);

  // Validate that a WITH resource type supports __enter__/__exit__ protocol.
  void ValidateContextManagerProtocol(const core::SourceLoc &loc, const std::string &language,
