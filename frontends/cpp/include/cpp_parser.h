...
private:
  ...
  std::shared_ptr<FunctionDecl> ParseFunctionWithSignature(
      std::shared_ptr<TypeNode> ret_type, const std::string &name, bool is_constexpr,
      bool is_consteval, bool is_inline, bool is_static, bool is_operator = false,
      const std::string &op_symbol = "", const std::string &access = "",
