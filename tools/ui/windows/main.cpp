 ...
 *           Windows build.  Bootstraps ThemeService and parses the
 *           CLI flags shared with the linux/macos mains.
 *
 * @ingroup  Tool / polyui
...
int main(int argc, char *argv[]) {
  ...
  if (opts.show_version) { PrintPolyUiVersion("Windows"); return 0; }
