...
private:
  ...
  std::vector<CompletionItem> CollectIdentifierCompletions(const std::string &prefix) const;
...
class CompletionModel : public QAbstractListModel {
  Q_OBJECT
public:
  explicit CompletionModel(QObject *parent = nullptr) : QAbstractListModel(parent) {}
...
public:
  ...
  void ShowCompletions(const std::vector<CompletionItem> &items, const QPoint &pos);
  void Hide();
