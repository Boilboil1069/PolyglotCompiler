...
QAction *ActionManager::RegisterAction(const QString &id, const QString &label,
...
void ActionManager::SetCustomShortcut(const QString &action_id, const QKeySequence &shortcut) {
...
QAction *ActionManager::RegisterPluginAction(const QString &plugin_id, const QString &action_id,
