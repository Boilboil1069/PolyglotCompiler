...
public:
  ...
  virtual SemanticDatabase Run(const FrontendOutput &input, frontends::Diagnostics &diagnostics,
...
public:
  ...
  virtual MarshalPlan Run(const SemanticDatabase &input, frontends::Diagnostics &diagnostics) = 0;
};
...
public:
  ...
  virtual BridgeGenerationOutput Run(const MarshalPlan &plan, const SemanticDatabase &sema_db,
                                     frontends::Diagnostics &diagnostics) = 0;
};
...
public:
  ...
  virtual BackendOutput Run(const SemanticDatabase &sema_db, const BridgeGenerationOutput &bridges,
...
public:
  ...
  virtual PackagingOutput Run(const BackendOutput &input, const CompilationContext::Config &config,
                              frontends::Diagnostics &diagnostics) = 0;
};
