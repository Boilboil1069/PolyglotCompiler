...
// ----------------------------------------------------------------------------
// Stable libruby ABI surface â€” declared as opaque so we never include ruby.h
...
// ----------------------------------------------------------------------------
// Value descriptor â€” matches javascript_rt's design so callers see a single
...
static int resolve_symbols(void) {
  ...
  // `rb_cObject` is exported as a data symbol â€” read its current value once.
