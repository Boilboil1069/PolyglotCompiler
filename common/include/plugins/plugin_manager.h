...
public:
  ...
  std::vector<const PolyglotCompletionProvider *> FindCompletionProviders(
      const std::string &language) const;

  // Collect all active diagnostic providers for a given language.
  std::vector<const PolyglotDiagnosticProvider *> FindDiagnosticProviders(
      const std::string &language) const;
  ...
  void RecordPluginFailure(const std::string &plugin_id, const std::string &error_msg);
  ...
  void RegisterFileType(const std::string &plugin_id, const std::string &extension,
  ...
  void RegisterMenuItem(const std::string &plugin_id, const PolyglotMenuContribution &item);

  // Unregister a menu item by action_id.
  void UnregisterMenuItem(const std::string &plugin_id, const std::string &action_id);

  // Retrieve all menu contributions from all active plugins.
  std::vector<std::pair<std::string, PolyglotMenuContribution>> GetMenuContributions() const;
  ...
  std::string GetPluginSetting(const std::string &plugin_id, const std::string &key) const;
  void SetPluginSetting(const std::string &plugin_id, const std::string &key,
  ...
  using LogCallback = std::function<void(const std::string &plugin_id, PolyglotLogLevel level,
  ...
  using DiagCallback =
      std::function<void(const std::string &plugin_id, const PolyglotDiagnostic &diag)>;
  ...
  using OpenFileCallback = std::function<void(const std::string &path, uint32_t line)>;
  ...
  using MenuItemCallback =
      std::function<void(const std::string &plugin_id, const PolyglotMenuContribution &item)>;
  ...
  using FileTypeCallback =
      std::function<void(const std::string &extension, const std::string &language)>;
