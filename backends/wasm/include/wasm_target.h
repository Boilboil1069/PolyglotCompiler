...
public:
  explicit WasmTarget(const polyglot::ir::IRContext *module = nullptr) : module_(module) {}
  ...
  void EmitInstructionWAT(std::ostream &os, const std::shared_ptr<ir::Instruction> &inst);
