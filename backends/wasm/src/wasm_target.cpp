...
static constexpr std::uint8_t kWasmMagic[] = {0x00, 0x61, 0x73, 0x6D};
static constexpr std::uint8_t kWasmVersion[] = {0x01, 0x00, 0x00, 0x00};

// Wasm opcode constants
static constexpr std::uint8_t kOpUnreachable = 0x00;
static constexpr std::uint8_t kOpNop         = 0x01;
static constexpr std::uint8_t kOpBlock       = 0x02;
static constexpr std::uint8_t kOpLoop        = 0x03;
static constexpr std::uint8_t kOpIf          = 0x04;
static constexpr std::uint8_t kOpElse        = 0x05;
static constexpr std::uint8_t kOpEnd         = 0x0B;
static constexpr std::uint8_t kOpBr          = 0x0C;
static constexpr std::uint8_t kOpBrIf        = 0x0D;
static constexpr std::uint8_t kOpReturn      = 0x0F;
static constexpr std::uint8_t kOpCall        = 0x10;
static constexpr std::uint8_t kOpDrop        = 0x1A;
static constexpr std::uint8_t kOpSelect      = 0x1B;
static constexpr std::uint8_t kOpLocalGet    = 0x20;
static constexpr std::uint8_t kOpLocalSet    = 0x21;
static constexpr std::uint8_t kOpLocalTee    = 0x22;
static constexpr std::uint8_t kOpGlobalGet   = 0x23;
static constexpr std::uint8_t kOpGlobalSet   = 0x24;
static constexpr std::uint8_t kOpI32Load     = 0x28;
static constexpr std::uint8_t kOpI64Load     = 0x29;
static constexpr std::uint8_t kOpF32Load     = 0x2A;
static constexpr std::uint8_t kOpF64Load     = 0x2B;
static constexpr std::uint8_t kOpI32Store    = 0x36;
static constexpr std::uint8_t kOpI64Store    = 0x37;
static constexpr std::uint8_t kOpF32Store    = 0x38;
static constexpr std::uint8_t kOpF64Store    = 0x39;
static constexpr std::uint8_t kOpI32Const    = 0x41;
static constexpr std::uint8_t kOpI64Const    = 0x42;
static constexpr std::uint8_t kOpF32Const    = 0x43;
static constexpr std::uint8_t kOpF64Const    = 0x44;
static constexpr std::uint8_t kOpI32Eqz      = 0x45;
static constexpr std::uint8_t kOpI32Eq       = 0x46;
static constexpr std::uint8_t kOpI32Ne       = 0x47;
static constexpr std::uint8_t kOpI32LtS      = 0x48;
static constexpr std::uint8_t kOpI32LtU      = 0x49;
static constexpr std::uint8_t kOpI32GtS      = 0x4A;
static constexpr std::uint8_t kOpI32GtU      = 0x4B;
static constexpr std::uint8_t kOpI32LeS      = 0x4C;
static constexpr std::uint8_t kOpI32LeU      = 0x4D;
static constexpr std::uint8_t kOpI32GeS      = 0x4E;
static constexpr std::uint8_t kOpI32GeU      = 0x4F;
static constexpr std::uint8_t kOpI64Eqz      = 0x50;
static constexpr std::uint8_t kOpI64Eq       = 0x51;
static constexpr std::uint8_t kOpI64Ne       = 0x52;
static constexpr std::uint8_t kOpI64LtS      = 0x53;
static constexpr std::uint8_t kOpI64LtU      = 0x54;
static constexpr std::uint8_t kOpI64GtS      = 0x55;
static constexpr std::uint8_t kOpI64GtU      = 0x56;
static constexpr std::uint8_t kOpI64LeS      = 0x57;
static constexpr std::uint8_t kOpI64LeU      = 0x58;
static constexpr std::uint8_t kOpI64GeS      = 0x59;
static constexpr std::uint8_t kOpI64GeU      = 0x5A;
static constexpr std::uint8_t kOpI32Add      = 0x6A;
static constexpr std::uint8_t kOpI32Sub      = 0x6B;
static constexpr std::uint8_t kOpI32Mul      = 0x6C;
static constexpr std::uint8_t kOpI32DivS     = 0x6D;
static constexpr std::uint8_t kOpI32DivU     = 0x6E;
static constexpr std::uint8_t kOpI32RemS     = 0x6F;
static constexpr std::uint8_t kOpI32RemU     = 0x70;
static constexpr std::uint8_t kOpI32And      = 0x71;
static constexpr std::uint8_t kOpI32Or       = 0x72;
static constexpr std::uint8_t kOpI32Xor      = 0x73;
static constexpr std::uint8_t kOpI32Shl      = 0x74;
static constexpr std::uint8_t kOpI32ShrS     = 0x75;
static constexpr std::uint8_t kOpI32ShrU     = 0x76;
static constexpr std::uint8_t kOpI64Add      = 0x7C;
static constexpr std::uint8_t kOpI64Sub      = 0x7D;
static constexpr std::uint8_t kOpI64Mul      = 0x7E;
static constexpr std::uint8_t kOpI64DivS     = 0x7F;
static constexpr std::uint8_t kOpI64DivU     = 0x80;
static constexpr std::uint8_t kOpI64RemS     = 0x81;
static constexpr std::uint8_t kOpI64RemU     = 0x82;
static constexpr std::uint8_t kOpI64And      = 0x83;
static constexpr std::uint8_t kOpI64Or       = 0x84;
static constexpr std::uint8_t kOpI64Xor      = 0x85;
static constexpr std::uint8_t kOpI64Shl      = 0x86;
static constexpr std::uint8_t kOpI64ShrS     = 0x87;
static constexpr std::uint8_t kOpI64ShrU     = 0x88;
static constexpr std::uint8_t kOpF64Abs      = 0x99;
static constexpr std::uint8_t kOpF64Neg      = 0x9A;
static constexpr std::uint8_t kOpF64Add      = 0xA0;
static constexpr std::uint8_t kOpF64Sub      = 0xA1;
static constexpr std::uint8_t kOpF64Mul      = 0xA2;
static constexpr std::uint8_t kOpF64Div      = 0xA3;
static constexpr std::uint8_t kOpF64Eq       = 0x61;
static constexpr std::uint8_t kOpF64Ne       = 0x62;
static constexpr std::uint8_t kOpF64Lt       = 0x63;
static constexpr std::uint8_t kOpF64Le       = 0x65;
static constexpr std::uint8_t kOpF64Gt       = 0x64;
static constexpr std::uint8_t kOpF64Ge       = 0x66;
static constexpr std::uint8_t kOpI32WrapI64  = 0xA7;
static constexpr std::uint8_t kOpI64ExtendI32S = 0xAC;
static constexpr std::uint8_t kOpI64ExtendI32U = 0xAD;

// Block type void
static constexpr std::uint8_t kBlockTypeVoid = 0x40;
