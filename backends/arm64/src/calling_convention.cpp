...
const Register kIntegerArgRegs[] = {Register::kX0, Register::kX1, Register::kX2, Register::kX3,
                                    Register::kX4, Register::kX5, Register::kX6, Register::kX7};

const Register kFloatArgRegs[] = {Register::kV0, Register::kV1, Register::kV2, Register::kV3,
                                  Register::kV4, Register::kV5, Register::kV6, Register::kV7};

const Register kCalleeSavedRegs[] = {Register::kX19, Register::kX20, Register::kX21, Register::kX22,
...
const Register kVolatileRegs[] = {
    Register::kX0,  Register::kX1,  Register::kX2,  Register::kX3,  Register::kX4,  Register::kX5,
    Register::kX6,  Register::kX7,  Register::kX8,  Register::kX9,  Register::kX10, Register::kX11,
    Register::kX12, Register::kX13, Register::kX14, Register::kX15, Register::kX16, Register::kX17};
      ...
      if (is_float) {
        if (float_arg_idx < static_cast<int>(float_regs.size())) {
          if (arg.kind == Operand::Kind::kImm || arg_str.find("[") == 0) {
            os << "  ldr " << RegisterName(float_regs[float_arg_idx]) << ", " << arg_str << "\n";
          } else {
            os << "  fmov " << RegisterName(float_regs[float_arg_idx]) << ", " << arg_str << "\n";
          }
          ++float_arg_idx;
        } else {
        ...
        if (int_arg_idx < static_cast<int>(int_regs.size())) {
          if (arg.kind == Operand::Kind::kImm) {
            os << "  mov " << RegisterName(int_regs[int_arg_idx]) << ", " << arg_str << "\n";
          } else if (arg_str.find("[") == 0) {
            os << "  ldr " << RegisterName(int_regs[int_arg_idx]) << ", " << arg_str << "\n";
          } else {
            os << "  mov " << RegisterName(int_regs[int_arg_idx]) << ", " << arg_str << "\n";
          }
          ++int_arg_idx;
